...
export const SESSION_RESPONSE_SYSTEM_PROMPT = [
  ...
  "- Anchor every reply in one concrete detail from the user's message — a word, an image, a moment — and reflect what they did not say outright rather than restating what they did. Never recap their whole message back to them.",
