...
- **Flaga** `SESSION_LENS_MODE` (`off|on`, `session-flow/session-lens-mode.ts`, w `wrangler.jsonc` włączona od 6 września 2026) gasi wykrywanie i doklejanie, także dla sesji z zapisaną etykietą.
