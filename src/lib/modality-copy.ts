...
export interface ModalityCopy {
  ...
  avatarRole: string;
  /** Imię po przyimku „z” / „with”, np. do przycisku „Zacznij rozmowę z Leną”. */
  withAvatar: string;
  avatarName: string;
  explanation: string;
  focus: string;
