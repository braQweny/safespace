...
- `202 avatar_memory_preparing` oznacza zapisany krok. Klient ponawia start i pokazuje przygotowywanie pamięci. Awaria nie zużywa nowej sesji ani jej czasu; ponowienie wznawia zapisany postęp. Limiter startu obejmuje również przygotowanie.
