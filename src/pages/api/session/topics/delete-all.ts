...
import { disableAndDeleteOwnedTopicMap } from "@/lib/session-data/repository";
...
/**
 * „Wyłącz i usuń mapę tematów” — natywny formularz (CSRF przez `checkOrigin`),
 * potwierdzenie jako wymagane pole wyboru. Działa niezależnie od flagi: dane
 * zapisane wcześniej zawsze da się usunąć. Karty osób zostają bez zmian.
 * Bez logowania i bez limitera.
 */
