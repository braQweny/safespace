...
export default function AvatarChoiceForm({ modalities, currentSelection }: AvatarChoiceFormProps) {
  ...
  return (
    // Strona robi teraz jedną rzecz — wybór perspektywy — więc karty dostają
    // całą szerokość zamiast dzielić ją z historią rozmów.
        ...
        {modalities.map((modality) => {
          ...
          return (
            ...
            >
              ...
              >
                <CheckCircle2 className={cn("h-5 w-5 transition-opacity", isSelected ? "opacity-100" : "opacity-0")} />
              </span>
