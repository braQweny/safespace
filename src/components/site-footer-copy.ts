...
const SITE_FOOTER_COPY = defineCopy(
  {
    disclaimer:
      "an educational conversation simulation — not therapy, a diagnosis or crisis help. In an emergency, call 112.",
  ...
  {
    disclaimer:
      "edukacyjna symulacja rozmowy — nie terapia, diagnoza ani pomoc kryzysowa. W nagłym zagrożeniu zadzwoń pod 112.",
