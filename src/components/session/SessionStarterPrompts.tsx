...
import { getSessionStarterPromptsCopy } from "./session-starter-prompts-copy";
...
export default function SessionStarterPrompts({ isDisabled, onSelect }: SessionStarterPromptsProps) {
  const copy = getSessionStarterPromptsCopy(useLocale());

  return (
    <div className="mx-auto w-full max-w-3xl shrink-0">
      <p className="text-ink-muted text-xs leading-5">{copy.intro}</p>
